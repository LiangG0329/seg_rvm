...
class MotionAugmentation:
    ...
    def __call__(self, fgrs, phas, bgrs):
        ...
        pa = transforms.Resize()
        # Resize
        params = transforms.RandomResizedCrop.get_params(fgrs, scale=(1, 1), ratio=self.aspect_ratio_range)
        #params = transforms.RandomResizedCrop.get_params(fgrs, scale=(1, 1), ratio=self.aspect_ratio_range,antialias=False)
        ...
        #params = transforms.RandomResizedCrop.get_params(bgrs, scale=(1, 1), ratio=self.aspect_ratio_range, antialias=False)
