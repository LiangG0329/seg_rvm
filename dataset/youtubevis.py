...
class YouTubeVISAugmentation:
    ...
    def __call__(self, imgs, segs):
        ...
        #imgs = F.resized_crop(imgs, *params, self.size, interpolation=F.InterpolationMode.BILINEAR, antialias=True)
        segs = F.resized_crop(segs, *params, self.size, interpolation=F.InterpolationMode.BILINEAR)
        #segs = F.resized_crop(segs, *params, self.size, interpolation=F.InterpolationMode.BILINEAR, antialias=True)
