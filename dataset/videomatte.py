...
class VideoMatteDataset(Dataset):
    def __init__(self,
        ...
        self.videomatte_clips = sorted(os.listdir(os.path.join(videomatte_dir, 'fgr')))  #../matting-data/VideoMatte240K_JPEG_SD/train/fgr/xxx
        self.videomatte_frames = [sorted(os.listdir(os.path.join(videomatte_dir, 'fgr', clip)))  #../matting-data/VideoMatte240K_JPEG_SD/train/fgr/xxx/xxx.jpg
