...
class CocoPanopticTrainAugmentation:
    ...
    def __call__(self, img, seg):
        ...
        #img = F.resized_crop(img, *params, self.size, interpolation=F.InterpolationMode.BILINEAR, antialias=True)
        seg = F.resized_crop(seg, *params, self.size, interpolation=F.InterpolationMode.NEAREST)
        #seg = F.resized_crop(seg, *params, self.size, interpolation=F.InterpolationMode.NEAREST, antialias=True)
